...
namespace Test1
{
    public static class Program
    {
        ...
        static int 算对(byte 花, int 点)
        {
            ...
            if (4 - 玩家_已知牌[花][点] == 2) score += P对_未现;
            else if (4 - 玩家_已知牌[花][点] == 1) score += P对_现一;
            else if (4 - 玩家_已知牌[花][点] == 0) score += P对_现二;

            switch (点)
            {
                case 1:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][2]) * P对_临
                           + (4 - 玩家_已知牌[花][3]) * P对_跳;
                    break;
                case 2:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][1]) * P对_临
                           + (4 - 玩家_已知牌[花][3]) * P对_临
                           + (4 - 玩家_已知牌[花][4]) * P对_跳;
                    break;
                case 3:                                         // 2 临 2 跳 （下同）
                    score += (4 - 玩家_已知牌[花][1]) * P对_跳
                           + (4 - 玩家_已知牌[花][2]) * P对_临
                           + (4 - 玩家_已知牌[花][4]) * P对_临
                           + (4 - 玩家_已知牌[花][5]) * P对_跳;
                    break;
                case 4:
                    score += (4 - 玩家_已知牌[花][2]) * P对_跳
                           + (4 - 玩家_已知牌[花][3]) * P对_临
                           + (4 - 玩家_已知牌[花][5]) * P对_临
                           + (4 - 玩家_已知牌[花][6]) * P对_跳;
                    break;
                case 5:
                    score += (4 - 玩家_已知牌[花][3]) * P对_跳
                           + (4 - 玩家_已知牌[花][4]) * P对_临
                           + (4 - 玩家_已知牌[花][6]) * P对_临
                           + (4 - 玩家_已知牌[花][7]) * P对_跳;
                    break;
                case 6:
                    score += (4 - 玩家_已知牌[花][4]) * P对_跳
                           + (4 - 玩家_已知牌[花][5]) * P对_临
                           + (4 - 玩家_已知牌[花][7]) * P对_临
                           + (4 - 玩家_已知牌[花][8]) * P对_跳;
                    break;
                case 7:
                    score += (4 - 玩家_已知牌[花][5]) * P对_跳
                           + (4 - 玩家_已知牌[花][6]) * P对_临
                           + (4 - 玩家_已知牌[花][8]) * P对_临
                           + (4 - 玩家_已知牌[花][9]) * P对_跳;
                    break;
                case 8:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][6]) * P对_跳
                           + (4 - 玩家_已知牌[花][7]) * P对_临
                           + (4 - 玩家_已知牌[花][9]) * P对_临;
                    break;
                case 9:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][7]) * P对_跳
                           + (4 - 玩家_已知牌[花][8]) * P对_临;
                    break;
            }
        ...
        static int 算刻(byte 花, int 点)
        {
            ...
            if (4 - 玩家_已知牌[花][点] == 1) score += P刻_未现;
            else if (4 - 玩家_已知牌[花][点] == 0) score += P刻_现一;

            switch (点)
            {
                case 1:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][2]) * P刻_临
                           + (4 - 玩家_已知牌[花][3]) * P刻_跳;
                    break;
                case 2:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][1]) * P刻_临
                           + (4 - 玩家_已知牌[花][3]) * P刻_临
                           + (4 - 玩家_已知牌[花][4]) * P刻_跳;
                    break;
                case 3:                                         // 2 临 2 跳 （下同）
                    score += (4 - 玩家_已知牌[花][1]) * P刻_跳
                           + (4 - 玩家_已知牌[花][2]) * P刻_临
                           + (4 - 玩家_已知牌[花][4]) * P刻_临
                           + (4 - 玩家_已知牌[花][5]) * P刻_跳;
                    break;
                case 4:
                    score += (4 - 玩家_已知牌[花][2]) * P刻_跳
                           + (4 - 玩家_已知牌[花][3]) * P刻_临
                           + (4 - 玩家_已知牌[花][5]) * P刻_临
                           + (4 - 玩家_已知牌[花][6]) * P刻_跳;
                    break;
                case 5:
                    score += (4 - 玩家_已知牌[花][3]) * P刻_跳
                           + (4 - 玩家_已知牌[花][4]) * P刻_临
                           + (4 - 玩家_已知牌[花][6]) * P刻_临
                           + (4 - 玩家_已知牌[花][7]) * P刻_跳;
                    break;
                case 6:
                    score += (4 - 玩家_已知牌[花][4]) * P刻_跳
                           + (4 - 玩家_已知牌[花][5]) * P刻_临
                           + (4 - 玩家_已知牌[花][7]) * P刻_临
                           + (4 - 玩家_已知牌[花][8]) * P刻_跳;
                    break;
                case 7:
                    score += (4 - 玩家_已知牌[花][5]) * P刻_跳
                           + (4 - 玩家_已知牌[花][6]) * P刻_临
                           + (4 - 玩家_已知牌[花][8]) * P刻_临
                           + (4 - 玩家_已知牌[花][9]) * P刻_跳;
                    break;
                case 8:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][6]) * P刻_跳
                           + (4 - 玩家_已知牌[花][7]) * P刻_临
                           + (4 - 玩家_已知牌[花][9]) * P刻_临;
                    break;
                case 9:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][7]) * P刻_跳
                           + (4 - 玩家_已知牌[花][8]) * P刻_临;
                    break;
            }
        ...
        static int 算坎(byte 花, int 点)
        {
            ...
            {
                case 1:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][2]) * P坎_临
                           + (4 - 玩家_已知牌[花][3]) * P坎_跳;
                    break;
                case 2:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][1]) * P坎_临
                           + (4 - 玩家_已知牌[花][3]) * P坎_临
                           + (4 - 玩家_已知牌[花][4]) * P坎_跳;
                    break;
                case 3:                                         // 2 临 2 跳 （下同）
                    score += (4 - 玩家_已知牌[花][1]) * P坎_跳
                           + (4 - 玩家_已知牌[花][2]) * P坎_临
                           + (4 - 玩家_已知牌[花][4]) * P坎_临
                           + (4 - 玩家_已知牌[花][5]) * P坎_跳;
                    break;
                case 4:
                    score += (4 - 玩家_已知牌[花][2]) * P坎_跳
                           + (4 - 玩家_已知牌[花][3]) * P坎_临
                           + (4 - 玩家_已知牌[花][5]) * P坎_临
                           + (4 - 玩家_已知牌[花][6]) * P坎_跳;
                    break;
                case 5:
                    score += (4 - 玩家_已知牌[花][3]) * P坎_跳
                           + (4 - 玩家_已知牌[花][4]) * P坎_临
                           + (4 - 玩家_已知牌[花][6]) * P坎_临
                           + (4 - 玩家_已知牌[花][7]) * P坎_跳;
                    break;
                case 6:
                    score += (4 - 玩家_已知牌[花][4]) * P坎_跳
                           + (4 - 玩家_已知牌[花][5]) * P坎_临
                           + (4 - 玩家_已知牌[花][7]) * P坎_临
                           + (4 - 玩家_已知牌[花][8]) * P坎_跳;
                    break;
                case 7:
                    score += (4 - 玩家_已知牌[花][5]) * P坎_跳
                           + (4 - 玩家_已知牌[花][6]) * P坎_临
                           + (4 - 玩家_已知牌[花][8]) * P坎_临
                           + (4 - 玩家_已知牌[花][9]) * P坎_跳;
                    break;
                case 8:                                         // 2 临 1 跳
                    score += (4 - 玩家_已知牌[花][6]) * P坎_跳
                           + (4 - 玩家_已知牌[花][7]) * P坎_临
                           + (4 - 玩家_已知牌[花][9]) * P坎_临;
                    break;
                case 9:                                         // 1 临 1 跳
                    score += (4 - 玩家_已知牌[花][7]) * P坎_跳
                           + (4 - 玩家_已知牌[花][8]) * P坎_临;
                    break;
            }
